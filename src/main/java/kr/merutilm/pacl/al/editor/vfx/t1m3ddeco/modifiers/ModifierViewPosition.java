 ...
 */
@SingleGroupModifier
public record ModifierViewPosition(int floor,
                                   double duration,
                                   @Nonnull Point3D destination,
                                   FunctionEase ease,
                                   double angleOffset) implements M3CModifier<ModifierViewPosition, Point3D> {

    @Override
    public Class<ModifierViewPosition> type() {
        return ModifierViewPosition.class;
    }
    ...
    public static final class Builder implements ModifierBuilder<ModifierViewPosition,Point3D> {
        private int floor;
        ...
        @Override
        public ModifierViewPosition build() {
            return new ModifierViewPosition(floor, duration, destination, ease, angleOffset);
        }
    }
}
