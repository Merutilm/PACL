...
final class CSTemplates {
    ...
    static HexColor getEventBaseColor(@Nonnull kr.merutilm.pacl.al.event.events.Event event) {
        final Color baseColor = switch (event) {
            case AddDecoration ignored -> new Color(0, 255, 255);
            case AddText ignored -> new Color(0, 255, 165);
            case AddObject ignored -> new Color(0, 255, 75);
            case AnimateTrack ignored -> new Color(255, 100, 255);
            case AutoPlayTiles ignored -> new Color(125, 125, 255);
            case Bloom ignored -> new Color(255, 255, 155);
            case Bookmark ignored -> new Color(100, 145, 105);
            case CheckPoint ignored -> new Color(0, 155, 255);
            case ColorTrack ignored -> new Color(155, 55, 55);
            case CustomBackground ignored -> new Color(162, 122, 122);
            case EditorComment ignored -> new Color(195, 70, 105);
            case Flash ignored -> new Color(160, 100, 165);
            case HallOfMirrors ignored -> new Color(180, 155, 122);
            case Hide ignored -> new Color(120, 166, 125);
            case Hold ignored -> new Color(100, 150, 255);
            case MoveCamera ignored -> new Color(50, 150, 145);
            case MoveDecorations ignored -> new Color(255, 55, 255);
            case MoveTrack ignored -> new Color(195, 195, 5);
            case MultiPlanet ignored -> new Color(142, 88, 129);
            case Pause ignored -> new Color(10, 125, 214);
            case PlaySound ignored -> new Color(10, 180, 145);
            case PositionTrack ignored -> new Color(50, 112, 215);
            case RecolorTrack ignored -> new Color(255, 255, 0);
            case RepeatEvents ignored -> new Color(9, 130, 165);
            case ScaleMargin ignored -> new Color(190, 90, 25);
            case ScalePlanets ignored -> new Color(190, 86, 84);
            case ScaleRadius ignored -> new Color(10, 150, 25);
            case ScreenScroll ignored -> new Color(100, 255, 125);
            case ScreenTile ignored -> new Color(160, 190, 226);
            case SetConditionalEvents ignored -> new Color(114, 98, 92);
            case SetFilter ignored -> new Color(125, 30, 190);
            case SetHitsound ignored -> new Color(155, 60, 155);
            case SetPlanetRotation ignored -> new Color(125, 123, 12);
            case SetSpeed ignored -> new Color(50, 50, 255);
            case SetText ignored -> new Color(60, 60, 255);
            case ShakeScreen ignored -> new Color(100, 150, 125);
            case Twirl ignored -> new Color(120, 60, 20);
